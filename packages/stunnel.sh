...
install -v -m750 -o stunnel -g stunnel -d $KPKG_TMP_DIR/var/lib/stunnel/run
chown stunnel:stunnel $KPKG_TMP_DIR/var/lib/stunnel

cat > $KPKG_TMP_DIR/etc/stunnel/stunnel.conf << "EOF"
